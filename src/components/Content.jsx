...
const Content = () => {
  return (
    <div className="text-white min-h-[80vh] flex items-center justify-center px-4 py-6 bg-cover bg-no-repeat bg-[#1c1251] " style={{ backgroundImage: `url(${assets.content})` }}>
      <div className="flex flex-col md:max-w-[60%] mx-auto items-center gap-6">
        ...
        <h2 className="text-5xl text-center font-semibold">Powerful Generator and Free Figma Sources</h2>
